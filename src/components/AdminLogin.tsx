...
const AdminLogin: React.FC<AdminLoginProps> = ({ onLogin }) => {
  ...
  const onSubmit = async (data: LoginFormData) => {
    ...
    try {
      ...
      // For now, we'll just simulate a successful login with admin/admin
      await new Promise(resolve => setTimeout(resolve, 1000));
      
      if (data.username === 'admin' && data.password === 'admin') {
        // Simulate JWT token
        const fakeToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiIxMjM0NTYiLCJyb2xlIjoiYWRtaW4iLCJpYXQiOjE2MTYxNjI4MDAsImV4cCI6MTYxNjE2NjQwMH0.fake-signature';
        onLogin(fakeToken);
      } else {
